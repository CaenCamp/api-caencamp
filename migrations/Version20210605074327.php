 ...
 */
final class Version20210605074327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE place ALTER country DROP DEFAULT');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE place ALTER country SET DEFAULT \'FR\'');
